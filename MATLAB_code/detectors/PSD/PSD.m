...
% Best PSD parameters
segmentLength = 8192;    % FFT length
overlapFactor = 0.60;    % Overlap factor (fraction)
maWindow      = 4;       % Moving average window for smoothing

% Best Noise Tracking & Adaptive Threshold Parameters
noiseWindow   = 200;     % Window for moving minimum (noise floor estimation)
localWindow   = 200;     % Window for computing local mean and std
k             = 0.06;    % Scaling factor for adaptive threshold
...
optimalThreshold = localMean + k * localStd;
